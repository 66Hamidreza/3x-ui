...
repo_slug="${XUI_REPO_SLUG:=66Hamidreza/3x-ui}"
repo_branch="${XUI_REPO_BRANCH:=main}"
github_api_base="https://api.github.com/repos/${repo_slug}"
github_release_base="https://github.com/${repo_slug}/releases/download"
github_raw_base="https://raw.githubusercontent.com/${repo_slug}/${repo_branch}"
...
prompt_and_setup_ssl() {
    ...
    1)
        ...
        if [[ -n "${cert_domain}" ]]; then
            ...
            echo -e "${green}Ã¢Å“â€œ SSL certificate configured successfully with domain: ${cert_domain}${plain}"
        else
    ...
    2)
        ...
        if [ $? -eq 0 ]; then
            SSL_HOST="${server_ip}"
            echo -e "${green}Ã¢Å“â€œ Let's Encrypt IP certificate configured successfully${plain}"
        else
            echo -e "${red}Ã¢Å“â€” IP certificate setup failed. Please check port 80 is open.${plain}"
            SSL_HOST="${server_ip}"
        fi
        ;;
    3)
        ...
        custom_domain="${custom_domain// /}" # ÃÂ£ÃÂ±ÃÂ¸Ã‘â‚¬ÃÂ°ÃÂµÃÂ¼ ÃÂ¿Ã‘â‚¬ÃÂ¾ÃÂ±ÃÂµÃÂ»Ã‘â€¹
        ...
        echo -e "${green}Ã¢Å“â€œ Custom certificate paths applied.${plain}"
...
config_after_install() {
    ...
    if [[ ${#existing_webBasePath} -lt 4 ]]; then
        if [[ "$existing_hasDefaultCredential" == "true" ]]; then
            ...
            echo ""
            echo -e "${green}Ã¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢Â${plain}"
            ...
            echo -e "${green}Ã¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢Â${plain}"
            echo -e "${yellow}Ã¢Å¡Â  IMPORTANT: Save these credentials securely!${plain}"
            echo -e "${yellow}Ã¢Å¡Â  SSL Certificate: Enabled and configured${plain}"
        else
            local config_webBasePath=$(gen_random_string 18)
...
install_x-ui() {
    ...
    echo -e ""
    echo -e "Ã¢â€Å’Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€Â
Ã¢â€â€š  ${blue}x-ui control menu usages (subcommands):${plain}              Ã¢â€â€š
Ã¢â€â€š                                                       Ã¢â€â€š
Ã¢â€â€š  ${blue}x-ui${plain}              - Admin Management Script          Ã¢â€â€š
Ã¢â€â€š  ${blue}x-ui start${plain}        - Start                            Ã¢â€â€š
Ã¢â€â€š  ${blue}x-ui stop${plain}         - Stop                             Ã¢â€â€š
Ã¢â€â€š  ${blue}x-ui restart${plain}      - Restart                          Ã¢â€â€š
Ã¢â€â€š  ${blue}x-ui status${plain}       - Current Status                   Ã¢â€â€š
Ã¢â€â€š  ${blue}x-ui settings${plain}     - Current Settings                 Ã¢â€â€š
Ã¢â€â€š  ${blue}x-ui enable${plain}       - Enable Autostart on OS Startup   Ã¢â€â€š
Ã¢â€â€š  ${blue}x-ui disable${plain}      - Disable Autostart on OS Startup  Ã¢â€â€š
Ã¢â€â€š  ${blue}x-ui log${plain}          - Check logs                       Ã¢â€â€š
Ã¢â€â€š  ${blue}x-ui banlog${plain}       - Check Fail2ban ban logs          Ã¢â€â€š
Ã¢â€â€š  ${blue}x-ui update${plain}       - Update                           Ã¢â€â€š
Ã¢â€â€š  ${blue}x-ui legacy${plain}       - Legacy version                   Ã¢â€â€š
Ã¢â€â€š  ${blue}x-ui install${plain}      - Install                          Ã¢â€â€š
Ã¢â€â€š  ${blue}x-ui uninstall${plain}    - Uninstall                        Ã¢â€â€š
